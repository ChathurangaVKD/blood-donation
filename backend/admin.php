<?php
// admin.php - Admin management functionality
session_start();
include 'db.php';
...
// Check if user is admin (simplified - in production, implement proper admin authentication)
function isAdmin() {
    return isset($_SESSION['admin_id']) || isset($_GET['admin_key']); // Temporary for testing
}
